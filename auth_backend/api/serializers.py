...
class LiveLocationUpdateSerializer(serializers.Serializer):
    ...
    movement_kind = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    signal_quality = serializers.CharField(required=False, allow_null=True, allow_blank=True)
...
class FriendLiveLocationSerializer(serializers.Serializer):
    ...
    movement_kind = serializers.CharField(required=False, allow_null=True)
...
class TrackPointWriteSerializer(serializers.Serializer):
    ...
    movement_state = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    movement_kind = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    break_reason = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    confidence_score = serializers.IntegerField(required=False, allow_null=True, min_value=0, max_value=100)
...
class TrackPointReadSerializer(serializers.Serializer):
    ...
    movement_state = serializers.CharField(required=False, allow_null=True)
    movement_kind = serializers.CharField(required=False, allow_null=True)
    break_reason = serializers.CharField(required=False, allow_null=True)
    confidence_score = serializers.IntegerField(required=False, allow_null=True)
    steps_delta = serializers.IntegerField(required=False, allow_null=True)
    recorded_at = serializers.DateTimeField()
